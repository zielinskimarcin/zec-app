...
export function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Mock login - w produkcji tutaj byłaby integracja z backendem
    navigate('/app');
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2">
                <input
                  type="checkbox"
                  className="size-4 rounded border-white/20 bg-white/5 text-white focus:ring-0 focus:ring-offset-0"
                />
