...
export function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Własna walidacja (zastępuje brzydkie dymki przeglądarki)
  ...
  return (
    <div className="min-h-screen bg-[#111111] flex items-center justify-center p-6 text-white font-sans relative overflow-hidden">
      ...
      <motion.div
        ...
        className="relative w-full max-w-md z-10" // Wróciliśmy do max-w-md (węższe, smuklejsze)
      >
        ...
        <div className="bg-[#0f0f0f] border border-[#1f1f1f] rounded-2xl p-8 shadow-2xl relative">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Rozpocznij z darmowym pakietem startowym.</p>
          </div>

          {/* Minimalistyczne przyciski Social */}
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-[10px] uppercase tracking-widest"><span className="px-3 bg-[#0f0f0f] text-gray-500 font-semibold">lub użyj emaila</span></div>
          </div>
          ...
          {!successMessage && (
            // noValidate wyłącza dymki HTML5 - sprawdzamy to w JS!
